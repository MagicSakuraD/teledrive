...
export default function Dashboard() {
  useEffect(() => {
    // WebRTC integration logic will go here
  ...
  return (
    <div className="grid h-screen w-full pl-[56px]">
      ...
      <div className="flex flex-col">
        ...
        <main className="flex overflow-auto p-4 container mx-auto">
          <div className="relative flex h-full min-h-[70vh] flex-col rounded-xl bg-muted/50 p-4 w-full">
